...
public class Parser{
	...
	private boolean thisIsTheEnd, antikeimeniki, correct;
	...
	public Parser() {
		...
		correct = correctType(fileName);
		
		if(correct) {
			//writeInFile();
			JOptionPane.showMessageDialog(null, "To proteuon grammiko provlima einai egkiro !!!", "Linear Problem compiled", JOptionPane.INFORMATION_MESSAGE);
		} else {
			errorGUI();
		}
